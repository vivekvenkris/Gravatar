...
import com.swin.util.Util;

public class ScalarTensorCalc implements Calculator{
	...
	public boolean findIntersection(PlotInputs p,Double m1, Double m2){
		
		return false;
	}
	
	
	public Double getPbDot(Double m1, Double m2){
		return 0.0;
	}
	public Double getOmDot(Double m1, Double m2){
		return 0.0;
	}
	public Double getGamma(Double m1, Double m2){
		return 0.0;
	}
