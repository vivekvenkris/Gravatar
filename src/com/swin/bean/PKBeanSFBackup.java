...
public class PKBeanSFBackup {
	...
	public PKBeanSFBackup(){}
	public PKBeanSFBackup(String name,Double value, Double error,Bounds bounds){
		this.name = name;
		this.value = value;
		this.error = error;
	...
	public List<Polygon> findIntersection(List<PKBeanSFBackup> PKBean){
		return null;
	...
	public static void setEccintricity(Double eccintricity) {
		PKBeanSFBackup.eccintricity = eccintricity;
		recompute = true;
	}
