...
import com.swin.manager.Calculations;
...
public void start(Stage stage) {
    ...
    final TableView<XYChart.Data<String,Number>> tableView = new TableView<XYChart.Data<String,Number>>();
        ...
        if (mouseEvent.getButton() == MouseButton.PRIMARY)
        {
                if (mouseEvent.getEventType() == MouseEvent.MOUSE_PRESSED) {
                    ...
                    else
                    {
                        ...
                        System.err.println("********"+lineChart.getChildrenUnmodifiable().size());
