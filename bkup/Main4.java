...
public class Main4 extends Application {
	...
	public void start(Stage primaryStage) {
		System.out.println("Using javafx version:"+ com.sun.javafx.runtime.VersionInfo.getRuntimeVersion());

		Double xmin=0.0,ymin=0.0;
		Double xmax=3.0,ymax=3.0;
		
		final NumberAxis xAxis = new NumberAxis(1.2,1.4,0.2);
        final NumberAxis yAxis = new NumberAxis(0.9,1.1,0.2);
		...
		zoomButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
            	System.err.println(zoomRect.getX() + " "+ zoomRect.getY());
...
//		parFile.setPbDot(pbDot);
	...
	private void setUpZooming(final Rectangle rect, final Node zoomingNode) {
        ...
        zoomingNode.setOnMouseDragged(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                double x = event.getX();
                double y = event.getY();
                System.err.println("x y "+x +" "+y+ " "+mouseAnchor.get().getX() + " "+ mouseAnchor.get().getY());
	...
	private void doZoom(Rectangle zoomRect, LineChart<Number, Number> chart){
        ...
        newUpperBound = yAxis.getUpperBound() - ((zoomRect.getY() - axisShift) / Tgap);
        newLowerBound = yAxis.getUpperBound() - (( zoomRect.getY() + zoomRect.getHeight() - axisShift) / Tgap);
       ...
       if (newUpperBound > yAxis.getUpperBound())
        ...
        newLowerBound = ((zoomRect.getX() - axisShift) / Tgap) + xAxis.getLowerBound();
        newUpperBound = ((zoomRect.getX() + zoomRect.getWidth() - axisShift) / Tgap) + xAxis.getLowerBound();                
	...
	private void doZoom3(Rectangle zoomRect, LineChart<Number, Number> chart) {
